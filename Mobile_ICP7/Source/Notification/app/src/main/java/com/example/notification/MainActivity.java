...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //To display the current date in the mobile app.
        displayDate = findViewById(R.id.dateDisplay);
        LocalDate today = LocalDate.now();
        DateTimeFormatter format = DateTimeFormatter.ofPattern("MM/dd/yyyy");
        displayDate.setText("Today's Date is: " + format.format(today));
        ...
        FloatingActionButton Add_To_CAL = findViewById(R.id.addToCal);
        Add_To_CAL.setOnClickListener(v -> Add_To_Cal());
    ...
    public void sendNotification(View view) {
        ...
        builder.setContentText("This is Notification App");
        builder.setStyle(new NotificationCompat.BigTextStyle().bigText("This is Notification App"));
